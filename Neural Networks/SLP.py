...
weights = {
    ...
    'hiddenlayer':tf.Variable(tf.random_normal([450, 200])),#Hidden layer1 will recieve an input of size 450 and gives a output of size 200
    'outputlayer': tf.Variable(tf.random_normal([200, output_dimensions]))# the output layer will recieve a input of size 200 and give an output of size 10
}
#Weights defined
...
main_vars = [weights['inputlayer'], weights['hiddenlayer'], weights['outputlayer'],
             biases['inputlayer'], biases['hiddenlayer'], biases['outputlayer']] # Making a list of tf.Variables for tensorflow to optimize
